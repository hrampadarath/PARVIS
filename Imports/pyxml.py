...
templatexml = 'config/config.xml'
outxml = 'config/DVA1_VLA.xml'
...
t = today.timetuple()
chan_width = 1.0 #MHz
ref_freq  = 660# for now assume this is the start freq in the 1st channel

root[3][0].text = " 'DVA1_VLA_A01' "
